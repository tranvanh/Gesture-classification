...
\begin{itemize}
    ...
    \item Gesticulation is commonly used along with the language group. These hand gestures are difficult to analyse.
	\item Language group of hand gestures form a grammatical structure for conversational style interfaces.
    \item Semaphoric hand gestures also may be referred to as communicative gestures, are a group of hand gestures serving as a set of symbols/commands used to interact with machines. The group consists of static hand gestures as well as dynamic hand gestures. 
\end{itemize}
