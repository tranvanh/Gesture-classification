...
\begin{enumerate}
    ...
    \begin{figure}[h]
        \centering
        \subfloat[\centering 0-fist]{{\includegraphics[width=2cm]{fist.png}}}%
        \qquad
        \subfloat[\centering 1-pointing]{{\includegraphics[width=2cm]{1_pointing.png}}}%
        \qquad
        \subfloat[\centering 2-peace sign]{{\includegraphics[width=2cm]{2_peace.png}}}%
        \qquad
        \subfloat[\centering 3]{{\includegraphics[width=2cm]{3.png}}}%
        \qquad
        \subfloat[\centering 4]{{\includegraphics[width=2cm]{4.png}}}%
        \qquad
        \subfloat[\centering 5-open hand]{{\includegraphics[width=2cm]{5_open_hand.png}}}%
        \qquad
        \subfloat[\centering 6-pinch]{{\includegraphics[width=2cm]{pinch.png}}}%
        \qquad
    ...
    \begin{figure}[h]
        \centering
        \subfloat[\centering 7-swipe right (using the whole hand)]{{\includegraphics[width=2cm]{dynamic_right_1.png}}}%
        \qquad
        \subfloat[\centering 7-swipe right (using the wrist)]{{\includegraphics[width=2cm]{dynamic_right_2.png}}}%
        \qquad
        \subfloat[\centering 8-swipe left (using the whole hand)]{{\includegraphics[width=2cm]{dynamic_left_1.png}}}%
        \qquad
        \subfloat[\centering 8-swipe left (using the wrist)]{{\includegraphics[width=2cm]{dynamic_left_2.png}}}%
...
The two-layered bidirectional LSTM architecture successfully learned dynamic gestures based on its characteristic movement, and it was also successful in classifying static gestures, both in real-time recognition.
