...
\begin{table}[ht]
    \centering
    \caption{Average recognition accuracies across different depths of bidirectional lstm architectures using 5-fold}
...
\begin{figure}[ht]
	\centering
    \includegraphics[width=11cm]{sliding_window.png}
