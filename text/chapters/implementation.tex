...
ASL Dataset was used to benchmark the model and further analysing optimal parameters. For the purpose of real-time recognition, we trained the model on our original dataset described at the end of section \ref{data_sampling}.
