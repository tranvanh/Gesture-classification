...
We had also examined bidirectional LSTM architectures with different number of layers, specifically 1 to 5 layers. The additional testing of the network's depth was to find out whether using different number of layers than proposed in \cite{bidirect_dynam} would make any improvements in overall prediction performance.
