As mentioned in \nameref{ch:introduction} chapter, we would want to evaluate the recognition performance based on a number of connected LMC sensors and test the capabilities of \nameref{ch:multileap} libray.
