...
\begin{description}
    ...
    \item In Chapter \nameref{ch:gesture_recognition}, we briefly explain gesture categories, discover some hardware image processing devices, and what are some of the proposed methods in the field of gesture recognition using machine learning techniques.
