...
void CModelWrapper::min_max_scaler(std::vector<float>& output, const std::vector<std::vector<float>> input)
{
    int ix = 0;
...
int CModelWrapper::preditct(const std::vector<std::vector<float>> input_data){
