...
public:
	...
	void scale(const std::list<const LEAP_TRACKING_EVENT*>& window, std::vector<float>& normalized_data);
private:
	int timeStep;
	int num_feature;
	...
	double internalAngle(const LEAP_VECTOR a, const LEAP_VECTOR b);
