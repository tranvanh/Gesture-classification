...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "094e692629d57ddb932fcc993193626f60daa61b"
  WORKING_DIRECTORY "C:/Users/tranv/source/repos/tranvanh/Gesture-classification/src/GestureApp/includes/tensorflow2/tensorflow/lite/out/build/x64-Debug (default)/xnnpack"
...
if("${show_ref_output}" MATCHES "refs/remotes/094e692629d57ddb932fcc993193626f60daa61b")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "094e692629d57ddb932fcc993193626f60daa61b")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "094e692629d57ddb932fcc993193626f60daa61b")
endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/tranv/source/repos/tranvanh/Gesture-classification/src/GestureApp/includes/tensorflow2/tensorflow/lite/out/build/x64-Debug (default)/xnnpack'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/tranv/source/repos/tranvanh/Gesture-classification/src/GestureApp/includes/tensorflow2/tensorflow/lite/out/build/x64-Debug (default)/xnnpack'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
